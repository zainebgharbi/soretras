...
describe('Contest Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'contest', component: ContestComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to contestService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getContestIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getContestIdentifier).toHaveBeenCalledWith(entity);
